...
from database.models.fazenda import Plantio
from database.models.irrigacao import Irrigacao
...
def get_irrigacao_page():
    ...
    return st.Page(render, title="Irrigação", url_path="irrigacao", icon="💧")